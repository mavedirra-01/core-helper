...
def nmap_verify_os(plugin_id, args, output_file):
    # Open the Nessus .csv file and read it
    ips = []
    ports = []
    global found
...
nmap_verify_os("33850", "-sC -sV -O -p", "unix_os_version.txt") # Unsupported unix OS
nmap_verify_os("108797", "-sC -sV -O", "windows_os_version.txt") # Unsupported windows OS
#########################################################################################
